...
function Projects(props) {
    const projectContent = props.posts.map((post) =>
        <div className={post.class} key={post.id}>
            <div className="col-4 section-margin">
                <h2 className="title">{post.title}</h2>
                <p className="text">{post.text}</p>
                <div className="device-icons_wrapper">
                    <img className="device-icons device-icons_desktop" src="dist/assets/img/icons/desktop_icon.svg" alt="desktop icon" />
                    <div className="device-icons_grouped" id="devicesGrouped">
                        <img className="device-icons device-icons_ipad" src="dist/assets/img/icons/ipad_icon.svg" alt="ipad icon" />
                        <img className="device-icons device-icons_mobile" src="dist/assets/img/icons/mobile_icon.svg" alt="mobile icon" />
                    </div>
                </div>
                <a className="web-link" href={post.href} target="_blank">View live site<div class="arrow_right"></div></a>
            </div>
            <div className="col-6 section-margin_sides">
